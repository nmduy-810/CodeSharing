...
public class LoginModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync(string returnUrl = null)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            if (user == null) user = await _userManager.FindByNameAsync(Input.UserNameOrEmail);
            ...
            var result =
                await _signInManager.PasswordSignInAsync(user.UserName, Input.Password, Input.RememberMe, true);
            if (result.Succeeded)
            {

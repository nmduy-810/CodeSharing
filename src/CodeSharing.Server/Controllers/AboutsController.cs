...
public class AboutsController : BaseController
{
    ...
    public AboutsController(ApplicationDbContext context, ILogger<AboutsController> logger, IStorageService storageService, IHttpContextAccessor httpContextAccessor)
    {
        _context = context;
    ...
    public async Task<IActionResult> GetById(int id)
    {
        ...
        if (about == null)
        {
            return NotFound(new ApiNotFoundResponse($"Cannot found about for id = {id} in database"));
        }
